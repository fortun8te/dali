...
speaker_to_json(struct player_speaker_info *spk)
{
  ...
  json_object_object_add(output, "connected", json_object_new_boolean(spk->connected));
  json_object_object_add(output, "streaming", json_object_new_boolean(spk->streaming));
